                            ...
                            <table class="table table-striped table-md">
                                ...
                                @foreach ($orders as $key => $value)
                                    <tr id="row_{{ $value->id }}" class="table-data-row">
                                        ...
                                        <td>
                                            <div class="ml-1">
                                                <a href="javascript:void(0)" class="modal-menu"
                                                   ...
                                                   data-toggle="modal"
                                                   data-target="#common-modal">{{ @$value->user->full_name }}</a>
                                                <br/>
                                        ...
                                        <td>
                                            <div class="badge badge-confirm">{{ $value->delivery_status }}</div>
                                        ...
                                        <td>
                                            ...
                                            <div class="dropdown-menu">
                                                <a href="{{ route('admin.delivery.pathao', ['orderId' => $value->id]) }}"
                                                    class="dropdown-item has-icon {{ $value->delivery_type ? 'disabled' : '' }}">
                                                    <i class='bx bx-truck'></i> {{ $value->delivery_type === 'pathao' ? 'Already Delivered' : 'Pathao Delivery' }}
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
