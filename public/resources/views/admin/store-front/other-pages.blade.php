                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @if (hasPermission('page_delete'))
                                                    @if ($value->id>8 ? 'visibility: visible' : '')
                                                        <a href="javascript:void(0)"
                                                           @if($value->id>8)
                                                           onclick="delete_row('delete/pages/', {{ $value->id }})"
                                                           @endif
                                                           class="btn btn-outline-danger btn-circle {{ $value->id>8 ? "" : "disabled" }}"
                                                           data-toggle="tooltip" title=""
                                                           data-original-title="{{ $value->id>8 ?__('Delete') : __('Can not delete this') }}">
