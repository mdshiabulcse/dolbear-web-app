                                ...
                                <form action="">
                                    <div class="form-group">
                                        <a href="{{ route('admin.clear.cache') }}"
                                            class="btn btn-outline-primary cache-btn">{{ __('Clear Cache') }}</a>
                                    </div>
                                </form>
                            @endif
                        </div>
                        <div class="col-md-10 middle card-body card-body-paddding">
                            <form action="{{ route('cache.update') }}" method="POST">
                                ...
                                <div id="driver"
                                    ...
                                    <div class="form-group">
                                        <label for="site-title" class="form-control-label">{{ __('Cache Driver') }}</label>
                                        <div class="custom-file">
                                    ...
                                    <div id="redis-cache"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="redis_host"
                                                value="{{ old('redis_host') != '' ? old('redis_host') : settingHelper('redis_host') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="redis_password"
                                                value="{{ old('redis_password') != '' ? old('redis_password') : settingHelper('redis_password') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="redis_port"
                                                value="{{ old('redis_port') != '' ? old('redis_port') : settingHelper('redis_port') }}"
