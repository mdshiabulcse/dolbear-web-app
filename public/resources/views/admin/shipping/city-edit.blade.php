    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Thana Update') }}</h2>
                        ...
                        <div class="card-body card-body-paddding">
                            <form action="{{ route('city.update') }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="modal-body modal-padding-bottom">
                                    ...
                                    <div class="form-group align-items-center">
                                        <label for="cost" class="form-control-label">{{ __('Delivery Cost') }}</label>
                                    ...
                                    <div class="form-group align-items-center">
                                        <label for="express_delivery_cost" class="form-control-label">{{ __('Express Delivery Cost') }}</label>
                                        <input type="number" step="any" name="express_delivery_cost" placeholder="Express Delivery Cost" value="{{ old('express_delivery_cost') ? old('express_delivery_cost') : priceFormatUpdate($city->express_delivery_cost,settingHelper('default_currency'),'*') }}" class="form-control" id="express_delivery_cost" required />
