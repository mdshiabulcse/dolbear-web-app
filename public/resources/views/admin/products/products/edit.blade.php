    ...
    <section class="section">
        <div class="section-body">
                    ...
                    <ul class="nav nav-pills" id="myTab3" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link bar active {{ has_key(['name', 'category', 'brand', 'unit', 'minimum_order_quantity', 'barcode', 'tags', 'slug', 'is_digital', 'product_file', 'external_link'], $errors) ? 'error' : '' }}"
                                ...
                                aria-controls="home" aria-selected="true">{{ __('Product Information') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link bar {{ has_key(['thumbnail', 'images', 'video_provider', 'video_url'], $errors) ? 'error' : '' }}"
                                ...
                                aria-controls="home" aria-selected="true">{{ __('Images & Videos') }}</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link bar {{ has_key(
                                [
                                    'price',
                                ...
                                aria-controls="contact" aria-selected="false">{{ __('Product Price & Stock') }}</a>
                        </li>
                        <li class="nav-item">
                        ...
                        {{-- @if (!isset($is_digital) && !isset($is_catalog) && !isset($is_classified))
                            <li class="nav-item">
                                <a class="nav-link bar shipping-days  {{ has_key(['shipping_type', 'shipping_fee', 'shipping_fee_depend_on_quantity', 'cash_on_delivery', 'estimated_shipping_days'], $errors) ? 'error' : '' }} }}"
                                    ...
                                    aria-controls="profile" aria-selected="false">{{ __('Shipping Info') }}</a>
                            </li>
                        @endif
                        @if (!isset($is_catalog) && !isset($is_classified))
                            <li class="nav-item">
                                <a class="nav-link bar {{ has_key(['campaign', 'campaign_discount', 'campaign_discount_type', 'is_refundable', 'is_featured', 'todays_deal'], $errors) ? 'error' : '' }}"
                                    id="others-tab" data-toggle="tab" href="#others" role="tab" aria-controls="contact"
                        ...
                        @if (isset($is_classified))
                            <li class="nav-item">
                                <a class="nav-link bar {{ has_key(['contact_name', 'email', 'phone_no', 'address', 'others'], $errors) ? 'error' : '' }}"
                                    ...
                                    aria-controls="contact" aria-selected="false">{{ __('Contact Details') }}</a>
                            </li>
                        @endif
                        <li class="nav-item">
                            <a class="nav-link bar {{ has_key(['meta_title', 'meta_description', 'meta_image', 'meta_keywords'], $errors) ? 'error' : '' }}"
                                id="seo-tab" data-toggle="tab" href="#seo" role="tab" aria-controls="contact"
            ...
            <form action="{{ $route }}" method="post" enctype="multipart/form-data"
                data-form="{{ $route_data_form }}" id="variant">
                @csrf
                <div class="row">
                    <div class="col-12 col-sm-12 col-md-8 col-lg-9 middle">
                            ...
                            <div class="tab-pane fade show active" id="product-info" role="tabpanel"
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                                    ...
                                                    <select class="form-control select2" name="category" id="category">
                                                        @foreach ($categories as $key => $category)
                                                            <option value="{{ $category->id }}"
                                                                {{ old('category') == $category->id ? 'selected' : ($product_language->product->category_id == $category->id ? 'selected' : '') }}>
                                                                {{ $category->getTranslation('title', App::getLocale()) }}
                                                            </option>
                                                            @foreach ($category->childCategories as $childCategory)
                                                                @include(
                                                                    'admin.products.categories.child-categories',
                                                                    [
                                                                        'child_category' => $childCategory,
                                                                        'parent' => old('category')
                                                                            ? old('category')
                                                                            : $product_language->product->category_id,
                                                                        'product' => true,
                                                                    ]
                                                                )
                                                            @endforeach
                                                    ...
                                                    <select class="form-control select2" name="brand" id="brand">
                                                        ...
                                                        @foreach ($brands as $brand)
                                                            <option value="{{ $brand->id }}"
                                                                {{ $brand->id == old('brand') ? 'selected' : ($product_language->product->brand_id == $brand->id ? 'selected' : '') }}>
                                                                {{ $brand->getTranslation('title', App::getLocale()) }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="unit" id="unit"
                                                        ...
                                                        class="form-control" placeholder="Unit ( e.g kg. pc. etc )">
                                                    @if ($errors->has('unit'))
                                                        <div class="invalid-feedback">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="minimum_order_quantity"
                                                        ...
                                                        placeholder="{{ __('Enter minimum order quantity') }}"
                                                        min="1">
                                        ...
                                        <label for="tags">{{ __('Enter product warrenty') }}</label>
                                        ...
                                        @endif
                                        <div
                                            class="digital-product-div {{ $product_language->product->is_digital == 1 || old('is_digital') == 1 ? '' : 'd-none' }}">
                                                ...
                                                <div class="form-group">
                                                    <div class="input-group gallery-modal" id="btnSubmit" data-for="all"
                                                        ...
                                                        <span class="form-control"><span
                                                                class="counter">{{ old('product_file') != '' ? substr_count(old('product_file'), ',') + 1 : ($product_language->product->product_file_id != '' ? substr_count($product_language->product->product_file_id, ',') + 1 : 0) }}</span>
                                                            {{ __('file chosen') }}</span>
                                                        ...
                                                        <div class="mt-2 gallery gallery-md d-flex">
                                                            ...
                                                            @if ($media)
                                                                <div class="selected-media mr-2 mb-2 mt-3 ml-0"
                                                                    ...
                                                                    <img src="{{ static_asset('images/default/default-' . $media->type . '-72x72.png') }}"
                                        ...
                                        @if (isset($is_catalog))
                                            ...
                                            <div
                                                class="form-group mt-2 external-link {{ old('is_catalog') ? (old('is_catalog') == 0 ? 'd-none' : '') : ($product_language->product->is_catalog == 0 ? 'd-none' : '') }}">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group gallery-modal" id="btnSubmit"
                                                            ...
                                                            <input type="hidden" name="thumbnail"
                                                                ...
                                                                class="image-selected">
                                                            <span class="form-control"><span
                                                                    class="counter">{{ old('thumbnail') != '' ? substr_count(old('thumbnail'), ',') + 1 : ($product_language->product->thumbnail_id != '' ? substr_count($product_language->product->thumbnail_id, ',') + 1 : 0) }}</span>
                                                                {{ __('file chosen') }}</span>
                                                            <div class="input-group-prepend">
                                                                <div class="input-group-text">
                                                                    {{ __('Choose File') }}
                                                                ...
                                                                @if ($thumbnail)
                                                                    <div class="selected-media mr-2 mb-2 mt-3 ml-0"
                                                                        ...
                                                                        @if (is_file_exists($thumbnail->image_variants['image_72x72'], $thumbnail->image_variants['storage']))
                                                                            <img src="{{ get_media($thumbnail->image_variants['image_72x72'], $thumbnail->image_variants['storage']) }}"
                                                                                alt="img-thumbnail"
                                                                                class="img-thumbnail logo-profile">
                                                                        @else
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="input-group gallery-modal" id="btnSubmit"
                                                            data-for="image" data-selection="multiple"
                                                            data-target="#galleryModal" data-dismiss="modal">
                                                            <input type="hidden" name="images"
                                                                value="{{ old('images') != '' ? old('images') : $product_language->product->image_ids }}"
                                                                class="image-selected">
                                                            <span class="form-control"><span
                                                                    class="counter">{{ old('images') != '' ? substr_count(old('images'), ',') + 1 : ($product_language->product->image_ids != '' ? substr_count($product_language->product->image_ids, ',') + 1 : 0) }}</span>
                                                                {{ __('file chosen') }}</span>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label
                                                        for="special_discount_type">{{ __('Special Discount Type') }}</label>
                                                    <select class="form-control selectric" name="special_discount_type"
                                                        ...
                                                        <option value="flat"
                                                            {{ old('special_discount_type') == 'flat' ? 'selected' : ($product_language->product->special_discount_type == 'flat' ? 'selected' : '') }}>
                                                            {{ __('Flat') }}</option>
                                                        <option value="percentage"
                                                            {{ old('special_discount_type') == 'percentage' ? 'selected' : ($product_language->product->special_discount_type == 'percentage' ? 'selected' : '') }}>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="special_discount" id="special_discount"
                                                        min="0" step="any"
                                                        value="{{ old('special_discount') != '' ? old('special_discount') : ($product_language->product->special_discount_type == 'flat' ? priceFormatUpdate($product_language->product->special_discount, settingHelper('default_currency'), $type = '*') : $product_language->product->special_discount) }}"
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="special_discount_period">{{ __('Special Discount Period') }}</label>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                ...
                                                <input type="text" name="special_discount_period"
                                                    ...
                                                    value="{{ old('special_discount_period')
                                                        ? old('special_discount_period')
                                                        : ($product_language->product->special_discount_type != ''
                                                            ? date('m-d-Y h:i A', strtotime($product_language->product->special_discount_start)) .
                                                                ' - ' .
                                                                date('m-d-Y h:i A', strtotime($product_language->product->special_discount_end))
                                                            : '') }}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control selectric" name="vat_taxes[]" id="vat_taxes"
                                                    ...
                                                    @foreach (\App\Models\VatTax::where('status', 1)->get() as $vat_tax)
                                                        <option value="{{ $vat_tax->id }}"
                                                            {{ old('vat_taxes') != '' ? (in_array($vat_tax->id, old('vat_taxes')) ? 'selected' : '') : (in_array($vat_tax->id, $vat_taxes) ? 'selected' : '') }}>
                                                            {{ $vat_tax->vat_tax }}
                                                            ({{ $vat_tax->percentage . '%' }})
                                                        </option>
                                                    @endforeach
                                            ...
                                            <div class="text-right">
                                                <label class="custom-switch">
                                                    <input type="checkbox" value="1" name="has_variant"
                                                        ...
                                                        {{ old('has_variant') == 1 ? 'checked' : ($product_language->product->has_variant == 1 ? 'checked' : '') }}>
                                                    <span class="custom-switch-indicator"></span>
                                                    <span
                                                        class="custom-switch-description">{{ __('Has Variant') }}</span>
                                                </label>
                                            ...
                                            @if (!$product_language->product->is_catalog == 1)
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label
                                                                for="low_stock_to_notify">{{ __('Minimum Stock Warning') }}</label>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="stock_visibility">{{ __('Stock Visibility') }}
                                                                *</label>
                                                            <select class="form-control selectric" name="stock_visibility"
                                                                id="stock_visibility">
                                                                <option value="hide_stock"
                                                                    {{ old('stock_visibility') == 'hide_stock' ? 'selected' : ($product_language->product->stock_visibility == 'hide_stock' ? 'selected' : '') }}>
                                                                    {{ __('Hide Stock') }}</option>
                                                                <option value="visible_with_quantity"
                                                                    {{ old('stock_visibility') == 'visible_with_quantity' ? 'selected' : ($product_language->product->stock_visibility == 'visible_with_quantity' ? 'selected' : '') }}>
                                                                    {{ __('Visible with quantity') }}</option>
                                                                <option value="visible_with_text"
                                                                    {{ old('stock_visibility') == 'visible_with_text' ? 'selected' : ($product_language->product->stock_visibility == 'visible_with_text' ? 'selected' : '') }}>
                                                                    {{ __('Visible with text') }}</option>
                                                            </select>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="text" name="sku" id="sku"
                                                                    value="{{ old('sku') != '' ? old('sku') : ($product_language->product->stock->first() ? $product_language->product->stock->first()->sku : '') }}"
                                                                    class="form-control"
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="row gutters-xs">
                                                        @foreach ($colors as $color)
                                                            <div class="col-auto">
                                                                <label class="colorinput" data-toggle="tooltip"
                                                                    title=""
                                                                    ...
                                                                    <input name="colors[]" type="checkbox"
                                                                        ...
                                                                        data-url="{{ route('get-attribute-values') }}"
...
{{--                                                                    {{ old('attribute_sets') ? (in_array($attribute->id, old('attribute_sets')) ? 'selected' : (in_array($attribute->id, $product_language->product->attribute_sets) ? 'selected' : '')) : (in_array($attribute->id, $product_language->product->attribute_sets) ? 'selected' : '') }}>--}}
{{--                                                                    {{ $attribute->getTranslation('title', App::getLocale()) }}--}}
{{--                                                                </option>--}}
{{--                                                            @endforeach--}}
{{--                                                        </select>--}}
{{--                                                        <p class="invalid-feedback text-info">--}}
{{--                                                            {{ __('N.B: Select Attribute sets of this product to add attribute values') }}--}}
{{--                                                        </p>--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
...
{{--                                                                            {{ old('attribute_values_' . $attribute->id)--}}
{{--                                                                                ? (in_array($value->id, old('attribute_values_' . $attribute->id))--}}
{{--                                                                                    ? 'selected'--}}
{{--                                                                                    : '')--}}
{{--                                                                                : ($product_language->product->selected_variants != null &&--}}
{{--                                                                                arrayCheck($attribute->id, $product_language->product->selected_variants)--}}
{{--                                                                                    ? (in_array($value->id, $product_language->product->selected_variants[$attribute->id])--}}
{{--                                                                                        ? 'selected'--}}
{{--                                                                                        : '')--}}
{{--                                                                                    : '') }}>--}}
{{--                                                                            {{ $value->value }}--}}
...
{{--                                                </div>--}}
                                                        ...
                                                        @if ($product_language->product->has_variant == 1)
                                                            <table
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    @php
                                                                        $processedVariantIds = []; // Array to track processed variant IDs
                                                                    @endphp
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                ...
                                                <textarea type="text" class="summernote ai_description" name="description" id="description">{{ old('description') ? old('description') : $product_language->description }}</textarea>
                                            </div>
                                                        ...
                                                        @foreach ($product_language->product->description_images as $image)
                                                            @if (is_file_exists($image['image'], $image['storage']))
                                                                <div class="position-relative">
                                                                    <img src="{{ get_media($image['image'], $image['storage']) }}"
                                                                        class="description_image"
                                                                        alt="{{ $product_language->name }}">
                                                                    <a href="javascript:void(0)"
                                                                        data-name="{{ $image['image'] }}"
                                                                        data-id="{{ $product_language->product_id }}"
                                                                        data-storage="{{ $image['storage'] }}"
                                                                        class="remove_image"><i class="bx bx-x"></i></a>
                                                                </div>
                                                            @endif
                                                        @endforeach
                                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit" data-for="pdf"
                                                    data-selection="single" data-variant="1" data-target="#galleryModal"
                                                    data-dismiss="modal">
                                                    <input type="hidden" name="pdf_specification"
                                                        ...
                                                        class="image-selected">
                                                    <span class="form-control"><span
                                                            class="counter">{{ old('pdf_specification') != '' ? substr_count(old('pdf_specification'), ',') + 1 : ($product_language->pdf_specification_id != '' ? substr_count($product_language->pdf_specification_id, ',') + 1 : 0) }}</span>
                                                        {{ __('file chosen') }}</span>
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            {{ __('Choose File') }}
                                                    ...
                                                    <div class="mt-2 gallery gallery-md d-flex">
                                                        ...
                                                        @if ($pdf)
                                                            <div class="selected-media mr-2 mb-2 mt-3 ml-0"
                                                                ...
                                                                <img src="{{ static_asset('images/default/default-pdf-72x72.png') }}"
                                                                    alt="img-thumbnail"
                                                                    class="img-thumbnail logo-profile">
                                                                <div class="image-remove">
                                                                    <a href="javascript:void(0)" class="remove"><i
                                            ...
                                            @if ($product_language->product->is_classified != 1)
                                                @if (addon_is_activated('ramdhani'))
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control selectric" name="shipping_class_id">
                                                            <option value="">{{ __('Select Shipping Class') }}
                                                            </option>
                                                            @foreach ($shipping_classes as $shipping_class)
                                                                <option value="{{ $shipping_class->id }}"
                                                                    {{ $product_language->product->shipping_class_id == $shipping_class->id ? 'selected' : '' }}>
                                                                    {{ $shipping_class->name }}</option>
                                                            @endforeach
                                                        </select>
                                                ...
                                                @else
                                                    @if (settingHelper('shipping_fee_type') == 'product_base')
                                                        ...
                                                        <div class="form-group mt-2">
                                                            <label
                                                                for="shipping_type">{{ __('Shipping Fee Type') }}</label>
                                                            <select class="form-control selectric shipping-type"
                                                                name="shipping_type" id="shipping_type">
                                                                <option value="flat_rate"
                                                                    {{ old('shipping_type') == 'flat_rate' ? 'selected' : ($product_language->product->shipping_type == 'flat_rate' ? 'selected' : '') }}>
                                                                    {{ __('Flat Rate') }}</option>
                                                                <option value="free_shipping"
                                                                    {{ old('shipping_type') == 'free_shipping' ? 'selected' : ($product_language->product->shipping_type == 'free_shipping' ? 'selected' : '') }}>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="form-group mt-2">
                                                                <label
                                                                    for="shipping_fee">{{ __('Shipping Fee') }}</label>
                                                            ...
                                                            <div class="form-group row mt-2">
                                                                ...
                                                                <div class="col-md-6">
                                                                    ...
                                                                    @if ($errors->has('shipping_fee_depend_on_quantity'))
                                                                        <div class="invalid-feedback">
                                                                            <p>{{ $errors->first('shipping_fee_depend_on_quantity') }}
                                                                            </p>
                                                                        </div>
                                                                    @endif
                                                                </div>
                                                ...
                                                @if ($product_language->product->is_digital != 1)
                                                    @if (!addon_is_activated('ramdhani'))
                                                        <div class="section-title mt-0">
                                                            {{ __('Estimated Shipping Days & COD') }}</div>
                                                        <div
                                                    ...
                                                    <div class="form-group mt-2 shipping-days">
                                                        <label
                                                            for="estimated_shipping_days">{{ __('Shipping Days') }}</label>
                            ...
                            {{-- <div class="tab-pane fade" id="others" role="tabpane3" aria-labelledby="others-tab">
                                <div class="card">
                                    ...
                                    <div class="card-body extra-padding">
                                        <div class="form-group">
                                            <label for="campaign">{{ __('Select Campaign') }}</label>
                                            <select class="form-control selectric" name="campaign" id="campaign">
                                                <option value="" selected>{{ __('Select') }}</option>
                                                @foreach ($campaigns as $campaign)
                                                    <option value="{{ $campaign->id }}"
                                                        {{ old('campaign') == $campaign->id ? 'selected' : ($product_language->productCampaign && $product_language->productCampaign->campaign_id == $campaign->id ? 'selected' : '') }}>
                                                        {{ $campaign->getTranslation('title', App::getLocale()) }}
                                                    </option>
                                                @endforeach
                                                @if ($errors->has('campaign'))
                                                    <div class="invalid-feedback">
                                                        <p>{{ $errors->first('campaign') }}</p>
                                                    </div>
                                                @endif
                                            </select>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="campaign_discount">{{ __('Discount') }}</label>
                                                    <input type="number" class="form-control" name="campaign_discount"
                                                        value="{{ old('campaign_discount') != '' ? old('campaign_discount') : ($product_language->productCampaign ? priceFormatUpdate($product_language->productCampaign->discount, settingHelper('default_currency'), $type = '*') : '') }}"
                                                        id="campaign_discount" placeholder="0" step="any"
                                                        min="0">
                                                    @if ($errors->has('campaign_discount'))
                                                        <div class="invalid-feedback">
                                                            <p>{{ $errors->first('campaign_discount') }}</p>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="campaign_discount_type">{{ __('Discount Type') }}</label>
                                                    <select class="form-control selectric" name="campaign_discount_type"
                                                        id="campaign_discount_type">
                                                        <option value="" selected>{{ __('Select Discount Type') }}
                                                        </option>
                                                        <option value="flat"
                                                            {{ old('campaign_discount_type') == 'flat' ? 'selected' : ($product_language->productCampaign && $product_language->productCampaign->discount_type == 'flat' ? 'selected' : '') }}>
                                                            {{ __('Flat') }}</option>
                                                        <option value="percent"
                                                            {{ old('campaign_discount_type') == 'percentage' ? 'selected' : ($product_language->productCampaign && $product_language->productCampaign->discount_type == 'percentage' ? 'selected' : '') }}>
                                                            {{ __('Percent') }}</option>
                                                    </select>
                                                    @if ($errors->has('campaign_discount_type'))
                                                        <div class="invalid-feedback">
                                                            <p>{{ $errors->first('campaign_discount_type') }}</p>
                                                        </div>
                                                    @endif
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-md-7">
                                                    <label class="custom-switch">
                                                        ...
                                                        <span class="custom-switch-indicator"></span>
                                                        <span
                                                            class="custom-switch-description">{{ __('Add to Gift Idea') }}</span>
                                                    </label>
                                            ...
                                            <div class="form-group row mt-2">
                                                ...
                                                <div class="col-md-7">
                                                    <label class="custom-switch">
                                                        ...
                                                        <span class="custom-switch-indicator"></span>
                                                        <span
                                                            class="custom-switch-description">{{ __('Add to Business Idea') }}</span>
                                                    </label>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="meta_description" rows="5">{{ old('meta_description') ? old('meta_description') : $product_language->meta_description }}</textarea>
                                        </div>
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <label
                                                for="logo">{{ __('Meta Image') . ' (' . __('Open Graph') . ')' }}</label>
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                                    data-selection="single" data-target="#galleryModal"
                                                    data-dismiss="modal">
                                                    <input type="hidden" name="meta_image"
                                                        value="{{ old('meta_image') != '' ? old('meta_image') : $product_language->product->meta_image_id }}"
                                                        class="image-selected">
                                                    <span class="form-control"><span
                                                            class="counter">{{ old('meta_image') != '' ? substr_count(old('meta_image'), ',') + 1 : ($product_language->product->meta_image_id != '' ? substr_count($product_language->product->meta_image_id, ',') + 1 : 0) }}</span>
                                                        {{ __('file chosen') }}</span>
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            {{ __('Choose File') }}
                                                        ...
                                                        @if ($meta_image)
                                                            <div class="selected-media mr-2 mb-2 mt-3 ml-0"
                                                                ...
                                                                @if (is_file_exists($meta_image->image_variants['image_72x72'], $meta_image->image_variants['storage']))
                                                                    <img src="{{ get_media($meta_image->image_variants['image_72x72'], $meta_image->image_variants['storage']) }}"
                                                                        alt="img-thumbnail"
                                                                        class="img-thumbnail logo-profile">
                                                                @else
                                                                    <img src="{{ static_asset('images/default/default-image-72x72.png') }}"
                                            ...
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea type="text" class="summernote" name="others" id="others">{{ old('others') != '' ? old('others') : @$product_language->product->contact_info['others'] }}</textarea>
