    ...
    <section class="section">
        <div class="section-body">
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    <h2 class="section-title">{{ __('Admin Products') }}</h2>
                                    ...
                                    <tbody>
                                        @foreach ($products as $key => $product)
                                            <tr id="row_{{ $product->id }}">
                                                    ...
                                                    <div class="d-flex">
                                                        <div class="text-left">
                                                            @if ($product->thumbnail != [] && @is_file_exists($product->thumbnail['image_40x40'], $product->thumbnail['storage']))
                                                                <img src="{{ get_media($product->thumbnail['image_40x40'], $product->thumbnail['storage']) }}"
                                                ...
                                                <td> {{ $product->createdBy ? $product->createdBy->first_name . ' ' . $product->createdBy->last_name : '' }}
                                                </td>
                                                <td>
                                                    <span>{{ __('Price') . ': ' . get_price($product->price, user_curr()) }}
                                                        /
                                                        {{ $product->getTranslation('unit', \App::getLocale()) }}</span><br>
