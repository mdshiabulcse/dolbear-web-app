                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" name="description" id="title"
                                       placeholder="{{ __('Enter Description') }}"
                                          class="form-control" >{{ old('description') ? old('description') : $campaignByLang->description }}</textarea>
...
{{--                            </div>--}}
                            <div class="form-group">
                                <label for="image">{{ __('Thumbnail') }} (374x374) </label>
                            ...
                            <div class="form-group">
                                <label for="image">{{ __('Banner') }} (1920x412)</label>
                                <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                     data-selection="single"
                                     data-target="#galleryModal" data-dismiss="modal">
