                                ...
                                <div class="card-body phone-block">
                                    ...
                                    <div class="form-group">
                                        @include('admin.partials.tel-input', [
                                            ...
                                            'country_id' =>
                                                old('country_id') ?:
                                                @$user->country_id ?? settingHelper('default_country'),
                                        ])
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <input type="file" class="custom-file-input image_pick file-select"
                                                accept="image/*" data-image-for="profile" name="image" id="customFile"
                                                value="{{ @$user->image_id }}" />
                                            @if ($errors->has('image'))
                                                <div class="invalid-feedback">
                                    ...
                                    <div class="role__showHide pt-4 pb-4">
                                        <div class="accordion" id="staffRoleForm">
                                            @foreach ($permissions as $permission)
                                                ...
                                                @if (in_array($permission->id, [1, 3, 4, 5, 6, 7, 8, 10, 13, 14, 17, 20, 21, 22, 28, 29, 30, 31, 32, 39]))
                                                    <div class="card">
                                                        ...
                                                        <div id="collapse_{{ $permission->id }}" class="collapse"
                                                            ...
                                                            <div class="card-body">
                                                                @if (
                                                                    $permission->attribute != 'wholesale_product' &&
                                                                        $permission->attribute != 'refund' &&
                                                                        $permission->attribute != 'reward_configuration' &&
                                                                        $permission->attribute != 'otp_system' &&
                                                                        $permission->attribute != 'offline_payment' &&
                                                                        $permission->attribute != 'chat_messenger' &&
                                                                        $permission->attribute != 'mobile_apps' &&
                                                                        $permission->attribute != 'mobile_app_intro' &&
                                                                        $permission->attribute != 'seller' &&
                                                                    ...
                                                                    @endforeach
                                                                @elseif(
                                                                    ($permission->attribute == 'wholesale_product' && addon_is_activated('wholesale')) ||
                                                                        ($permission->attribute == 'refund' && addon_is_activated('refund')) ||
                                                                        ($permission->attribute == 'reward_configuration' && addon_is_activated('reward')) ||
                                                                        ($permission->attribute == 'otp_system' && addon_is_activated('otp_system')) ||
                                                                        ($permission->attribute == 'offline_payment' && addon_is_activated('offline_payment')) ||
                                                                        ...
                                                                        ($permission->attribute == 'seller' && settingHelper('seller_system') == 1) ||
