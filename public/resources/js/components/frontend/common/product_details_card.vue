    ...
    <div class="row product-details-card">
      <div class="col-lg-5" v-if="lengthCounter(productDetails.gallery) > 0">
        <div class="product-slider-section slider-arrows">
          <div>
            <CoolLightBox style="direction: ltr" :items="productDetails.gallery.large" :index="index" :useZoomBar="true"
              @close="index = null">
            </CoolLightBox>
      ...
      <div class="col-lg-7">
        ...
        <div class="d-flex flex-wrap gap-2">
          ...
          <div class="tab-content">
            <h4>SKU : {{ productDetails.stock[0]?.sku ?? "" }}</h4>
          </div>
          <div class="tab-content">
        ...
        <div class=" d-flex gap-2 align-items-center" v-if="productDetails?.product_colors?.length > 0">
          <h4>Color:</h4>
          <div class="d-flex gap-2 align-items-center">
            <div class="d-flex gap-2 align-items-center">
              <div v-for="(color, index) in productDetails?.product_colors" :key="index"
                :style="{ backgroundColor: color?.code }" :class="{ active: selectedColor === color?.code }"
                @click="selectColor(color)" class="attribute-item"></div>
            </div>

            <!-- <div style="background-color: red;" class="attribute-item"></div>
            <div style="background-color: green;" class="attribute-item"></div>
            <div style="background-color: black;" class="attribute-item"></div> -->
          </div>
        </div>
        ...
        <div class="price-section d-flex mt-3">
          ...
          <div class="d-flex flex-column justify-content-center ms-3">
            <div class="d-flex gap-2 align-items-center">
              <h4 class="current-price">{{ selectedColor ? priceFormat(this.product_form.variant_price) : priceFormat(productDetails.price) }}</h4>
<!--              <span>|</span>-->
<!--              <h4>৳{{ productDetails.price }}</h4>-->
        ...
        <div class="d-flex gap-2 align-items-center mt-3 mb-3 mb-md-0">
...
export default {
  ...
  watch: {
    productDetails() {
      console.log("details card description", this.productDetails)
