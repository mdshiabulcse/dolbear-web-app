        ...
        <div class="row sg-category-content sg-filter grid-view-tab" :class="activeClass">
                ...
                <div class="accordion-item" v-if="addons.includes('ramdhani') || form.route != 'product.by.brand'">
                  <div class="accordion-header" id="ac4">
                    <button class="accordion-button" @click="brand = !brand" :class="{ collapsed: !brand }"
                            ...
                            aria-expanded="false" aria-controls="brand_collapse">{{ lang.brand }}
                    </button>
                  </div>
                    ...
                    <div class="accordion-body">
                      <form action="#" class="form-checkbox">
                        ...
                        <div v-if="brands.data && brands.data.length>0"
                             v-observe-visibility="handleScrolledForBrands"></div>
                      </form>
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  <div class="accordion-header" id="ac3">
                    <button class="accordion-button" @click="price = !price" :class="{ collapsed: !price }"
                            type="button" data-bs-toggle="collapse"
                            aria-expanded="false" aria-controls="collapse2">{{ lang.price }}
                    </button>
                  </div>
                ...
                <div class="accordion-item" v-if="settings.color == 1">
                  <div class="accordion-header" id="ac5">
                    <button class="accordion-button" @click="color = !color" :class="{ collapsed: !color }"
                            ...
                            aria-controls="collapse5">{{ lang.color }}
                    </button>
                  </div>
                ...
                <div class="accordion-item">
                  <div class="accordion-header" id="ac6">
                    <button class="accordion-button" @click="ratting = !ratting" :class="{ collapsed: !ratting }"
                            type="button" data-bs-toggle="collapse" aria-expanded="false"
                            aria-controls="collapse6">{{ lang.ratting }}
                    </button>
                  </div>
          ...
          <div class="col-md-8 col-lg-9">
              ...
              <div class="cta mb-4" v-if="page && page.image_835x200">
                <div v-if="page.image_835x200 == getUrl('images/default/default-image-835x200.png')">
                  <a v-if="settings.category_default_banner != null"><img loading="lazy"
                                                                          ...
                                                                          :alt="form.slug" class="img-fluid"/></a>
                  <a v-else><img loading="lazy" :src="page.image_835x200" :alt="form.slug" class="img-fluid"/></a>
                </div>
                <div v-else>
              ...
              <div class="d-flex justify-content-between mb-4">
                ...
                <div class="right-content">
                  <div class="d-flex gap-3">
                    <form>
                      <div class="form-group">
                        <select v-model="form.paginate" @change="sortProducts" class="form-control" style="padding-right: 30px;">
            ...
            <div>
              ...
              <product :products="productList" :number="8" :grid_class="width > 769 ? 'grid-4' : 'grid-2'"></product>
