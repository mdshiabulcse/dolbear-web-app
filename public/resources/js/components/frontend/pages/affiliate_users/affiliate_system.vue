            ...
            <div class="row" v-if="is_shimmer">
              ...
              <div class="col-md-3">
                ...
                >
                  ...
                  <h3 class="text-black">
                    {{ affiliate_states.no_of_order_item }}
                  </h3>
                </div>
              </div>
              <div class="col-md-3">
                ...
                >
                  ...
                  <h3 class="text-black">
                    {{ affiliate_states.no_of_delivered }}
                  </h3>
                </div>
              </div>
              <div class="col-md-3">
                ...
                <div class="card">
                  <div class="form-box-content p-3">
                    ...
                    <div class="form-group">
                      <textarea
                        class="form-control affiliate_link"
                        readonly
                        type="text"
                        >{{ affiliate_link }}</textarea
                      >
                    </div>
                    <div class="form-group">
                      <input
                        type="hidden"
                        class="form-control"
                        :id="'testing-code_' + affiliate_link"
              ...
              <div class="col-md-12 overflow-y-auto">
                <div class="sg-table">
                  ...
                  <table class="table dashboard-table">
                    ...
                    <tbody>
                      <tr
                        v-for="(product, index) in affiliate_products.data"
                        :key="index"
                      >
                        ...
                        <td>
                          You will get {{ product.affiliate_amount }}% Per Sale
                        </td>
                        <td>
                          {{ url }}/product/{{ product.slug }}?referral_code={{
...
export default {
  ...
  mounted() {
    this.loadWallets();
    this.affiliate_link =
      this.getUrl("register") + "?referral_code=" + this.authUser.referral_code;
  },
  computed: {
    wallets() {
  ...
  methods: {
    ...
    copyToClipboard() {
      var copyText = document.getElementById(
        "testing-code_" + this.affiliate_link
      );
