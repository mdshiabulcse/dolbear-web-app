...
<!--              </div>-->
              ...
              <!-- <div class="col-md-4" v-if="settings.wallet_system == 1">
                <router-link :to="{ name: 'wallet.history' }">
                  ...
                  >
                    <div class="profile-card-title text-black mb-3">
                      {{ lang.wallet_balance }}
                    </div>
                    <h3 class="text-black">
              ...
              <!-- <div class="col-md-4" v-if="settings.wallet_system == 1">
                <div
                  class="card text-center profile-card d-flex justify-center profile-card-white"
                >
                  <div class="profile-card-title mb-3 text-black">
                    {{ lang.last_recharge }}
                  </div>
                  <h3 class="text-black">
                      ...
                      >
                        <div class="input-checkbox">
                          ...
                          <label for="ssl_commerze">
                            <img
                              :src="
                                getUrl('images/payment-method/sslcommerze.svg')
                              "
                              :alt="payment_form.payment_type"
                              width="90"
                            />
                      ...
                      >
                        <div class="input-checkbox">
                          ...
                          <label for="razor_pay">
                            <img
                              :src="
                                getUrl('images/payment-method/razorpay.svg')
                              "
                              :alt="payment_form.payment_type"
                              width="90"
                              class="img-fluid"
                      ...
                      >
                        <div class="input-checkbox">
                          ...
                          <label for="jazzCash">
                            <img
                              :src="
                                getUrl('images/payment-method/jazzCash.svg')
                              "
                              :alt="payment_form.payment_type"
                              width="90"
                              class="img-fluid"
                      ...
                      >
                        <div class="input-checkbox">
                          ...
                          <label for="paystack">
                            <img
                              :src="
                                getUrl('images/payment-method/paystack.svg')
                              "
                              :alt="payment_form.payment_type"
                              width="90"
                              class="img-fluid"
                      ...
                      >
                        <div class="input-checkbox">
                          ...
                          <label for="mercadopago">
                            <img
                              :src="
                                getUrl('images/payment-method/mercado-pago.svg')
                              "
                              :alt="payment_form.payment_type"
                              width="90"
                              class="img-fluid"
                            />{{ lang.pay_with_mercadopago }}</label
                          >
                        </div>
                      </li>
                      <li
                        v-if="
                          settings.is_bkash_activated && checkCurrency('BDT')
                        "
                      >
                        <div class="input-checkbox">
                          <input
                      ...
                      <li v-if="settings.is_google_pay_activated">
                        <div class="input-checkbox">
                          ...
                          <label for="google_pay">
                            <img
                              :src="
                                getUrl('images/payment-method/google_pay.svg')
                              "
                              :alt="payment_form.payment_type"
                              width="90"
                              class="img-fluid"
                            />{{ lang.pay_with_google_pay }}</label
                          >
                        </div>
                      </li>
                      <li
                        v-if="
                          settings.is_nagad_activated && checkCurrency('BDT')
                        "
                      >
                        <div class="input-checkbox">
                          <input
                          ...
                          <label for="nagad">
                            <img
                              ...
                              width="90"
                              class="img-fluid"
                            />{{ lang.pay_with_nagad }}</label
                          >
                        </div>
                      </li>
                      <li
                        v-if="
                          settings.is_amarpay_activated && checkCurrency('BDT')
                        "
                      >
                        <div class="input-checkbox">
                          <input
                        ...
                        <div class="input-checkbox">
                          ...
                          <label for="hitpay">
                            <img
                              ...
                              width="90"
                              class="img-fluid"
                            />{{ lang.pay_with_hitpay }}</label
                          >
                        </div>
                      </li>
                      <li
                        v-if="
                          settings.is_mid_trans_activated &&
                          checkCurrency('IDR')
                        "
                      >
                        <div class="input-checkbox">
                          ...
                          <label for="mid_trans">
                            <img
                              :src="
                                getUrl('images/payment-method/midtrans.svg')
                              "
                              :alt="payment_form.payment_type"
                              width="90"
                              class="img-fluid"
                            />{{ lang.pay_with_mid_trans }}</label
                          >
                        </div>
                      </li>
                        ...
                        <div class="input-checkbox">
                          ...
                          <label for="kkiapay">
                            <img
                              ...
                              width="90"
                              class="img-fluid"
                            />{{ lang.pay_with_kkiapay }}</label
                          >
                        </div>
                      </li>
                      <li
                        v-if="addons.includes('offline_payment')"
                ...
                >
                  <div class="col-lg-5" id="payment_buttons">
                    ...
                    <a
                      :href="
                        getUrl(
                          'mercadopago/redirect/wallet?amount=' + form.total
                        )
                      "
                      class="btn btn-primary w-100"
                    ...
                    <a
                      :href="
                        getUrl('nagad/redirect/wallet?amount=' + form.total)
                      "
                      class="btn btn-primary w-100"
                    ...
                    <a
                      :href="
                        getUrl('telr/redirect/wallet?amount=' + form.total)
                      "
                      class="btn btn-primary w-100"
  ...
  methods: {
    ...
    integrateRazorPay() {
      ...
      if (
        ...
        myScript.setAttribute(
          "src",
          this.getUrl("frontend/js/razor_pay_checkout.js")
        );
