            ...
            <ul v-if="authUser && authUser.user_type == 'customer'">
              ...
              <li
                ...
                v-observe-visibility="
                  index === sellers.data.length - 1 ? loadSellers : false
                "
              >
                <a
                ...
                >
                  ...
                  <div class="user-info">
                    ...
                    <p v-if="seller.has_message" class="text-overflow">
          ...
          <div class="chatbox" id="chatbox">
            ...
            >
              ...
              <div
                ...
                :class="{ page_1: message.page == 1, user: message.type == 2 }"
              >
                <div v-if="message.is_file" class="message-text">
                  ...
                  >
                    <img
                      v-if="message.file_exist"
                      :src="message.file_url"
                      :alt="message.message"
                    />
                    <img
                      v-else
                      :src="getUrl('images/default/no_image.jpg')"
                      :alt="message.message"
                    />
                  </a>
                ...
                <div class="message-sender-img">
                  ...
                  <img
                    v-else
                    :src="selected_user.logo"
                    :alt="selected_user.user_name"
                  />
                </div>

                <span
                  class="warning_mgs"
                  v-if="message.is_file && !message.file_exist"
                  >{{ lang.file_not_exist }}.</span
                >
              </div>
            </div>

            <h6
              class="text-danger text-center mt-5 pt-5"
              v-if="
                messages.length == 0 &&
                authUser &&
                authUser.user_type == 'customer'
            ...
            <h6
              class="text-danger text-center mt-5 pt-5"
              v-if="authUser && authUser.user_type == 'seller'"
            >
  ...
  methods: {
          ...
          if (response.data.error) {
            ...
            for (let i = 0; i < messages.length; i++) {
              ...
              if (!find) {
                ...
                let element = document.getElementById("chatbox");
                element.scrollTop =
                  element.scrollHeight - (element.scrollHeight - 500);
              }
            }
            that.scroll_continue = true;
    ...
    imagePreview(file) {
      if (file.type.split("/")[0] == "image") {
        ...
        return this.getUrl("images/default/default-document-40x40.png");
      }
    },
    searchUser() {
      this.page = 1;
