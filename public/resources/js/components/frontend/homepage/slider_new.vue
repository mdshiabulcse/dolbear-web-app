<template>
	<div>
		...
		<section class="container">
			<div class="hero-slider-new" v-if="images.length > 0">

				<carousel style="z-index: 0 !important;" :autoplay="true" :loop="true" :nav="false" :margin="0" :items="1" :dots="false"
					:autoplayTimeout="3000" :autoplayHoverPause="true" width="100%" height="100%">
...
export default {
	...
	methods: {
		...
		loadImages() {
			...
			this.images = [
				{ url: `${baseUrl}/images/hero_image.png`, alt: 'Image 1' },
				// { url: `${baseUrl}/images/hero_image.png`, alt: 'Image 2' },
				// { url: `${baseUrl}/images/hero_image.png`, alt: 'Image 3' },
				// { url: `${baseUrl}/images/hero_image.png`, alt: 'Image 4' },
