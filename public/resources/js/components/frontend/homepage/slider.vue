...
export default {
    ...
    closeModal() {
      ...
      this.images = [
        { url: require('../../../../../public/images/img/headphone.png'), alt: 'Image 1' },
        { url: require('../../../../../public/images/img/shoe.png'), alt: 'Image 2' },
        { url: require('../../../../../public/images/img/clock.png'), alt: 'Image 3' }
      ];
