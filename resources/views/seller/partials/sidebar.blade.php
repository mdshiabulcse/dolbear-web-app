<div class="main-sidebar">
    <aside id="sidebar-wrapper">
        <div class="sidebar-brand sidebar-brand-sm">
            <a
                href="{{ route('seller.dashboard') }}">{{ settingHelper('system_short_name') ? settingHelper('system_short_name', app()->getLocale()) : 'Dolbear' }}</a>
        </div>
        ...
        <ul class="sidebar-menu">
            ...
            @if (addon_is_activated('chat_system'))
                <li class="@yield('chat_system')"><a class="nav-link" href="{{ route('messages') }}"><i
