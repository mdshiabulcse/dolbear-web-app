            ...
            <div class="d-flex justify-content-between">
                <div class="d-block">
                    ...
                    <p class="section-lead">
                        {{ __('You have total') . ' ' . $coupons->total() . ' ' . __('coupons') }}
                    </p>
                </div>
            </div>
        </div>
                            ...
                            <table class="table table-striped table-md">
                                ...
                                @foreach ($coupons as $key => $coupon)
                                    <tr id="row_{{ $coupon->id }}" class="table-data-row">
                                        ...
                                        <td><label class="custom-switch mt-2 {{ hasPermission('coupon_update') ? '' : 'cursor-not-allowed' }}">
                                                <input type="checkbox" name="custom-switch-checkbox"
                                                       value="coupon-status-change/{{$coupon->id}}"
                                                       {{ hasPermission('coupon_update') ? '' : 'disabled' }}
                                                       {{ $coupon->status == 1 ? 'checked' : '' }} class="{{ hasPermission('coupon_update') ? 'status-change' : '' }} custom-switch-input">
                            ...
                            <form method="POST" action="{{ route('coupon.store') }}" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <select class="form-control selectric" name="type" id="couponType" >
                                            {{-- <option
