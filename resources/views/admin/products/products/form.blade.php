                                                        ...
                                                        <select class="form-control select2 attribute-sets"
                                                            ...
                                                            @foreach ($attributes as $attribute)
                                                                <option value="{{ $attribute->id }}"
                                                                    {{ old('attribute_sets') ? (in_array($attribute->id, old('attribute_sets')) ? 'selected' : '') : '' }}>
                                                                ...
                                                                <select class="form-control select2 variant"
                                                                    ...
                                                                    @foreach ($attribute->attributeValue as $value)
                                                                        <option value="{{ $value->id }}"
                                                                            {{ old('attribute_values_' . $attribute->id) ? (in_array($value->id, old('attribute_values_' . $attribute->id)) ? 'selected' : '') : '' }}>
                                                                            {{ $value->value }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                    ...
                                    <div class="card-body">
                                        <div class="form-group short-des">
                                            ...
                                            <div>
                                                ...
                                                <textarea type="text" class="form-control ai_short_description" name="short_description" id="short_description">{{ old('short_description') ? old('short_description') : '' }}</textarea>
                                            </div>
