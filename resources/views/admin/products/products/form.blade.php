                    ...
                    <div class="tab-content no-padding" id="myTabContent2">
                        <div class="tab-pane fade show active" id="product-info" role="tabpanel"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control ai_content_name" name="code"
                                               id="name"
                                               value="{{ old('code') ? old('code') : (@$product_language ? $product_language->code : '') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control selectric" name="free_shipping"
                                                id="free_shipping">
                                ...
                                @endif --}}
                                <div
                                    class="digital-product-div {{ isset($is_digital) || old('is_digital') == 1 ? '' : 'd-none' }}">
                                        ...
                                        <div class="form-group">
                                            <div class="input-group gallery-modal" id="btnSubmit" data-for="all"
                                                ...
                                                <span class="form-control"><span
                                                        class="counter">{{ old('product_file') != '' ? substr_count(old('product_file'), ',') + 1 : '' }}</span>
                                                    {{ __('file chosen') }}</span>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit"
                                                    ...
                                                    <span class="form-control"><span
                                                            class="counter">{{ old('thumbnail') != '' ? substr_count(old('thumbnail'), ',') + 1 : 0 }}</span>
                                                        {{ __('file chosen') }}</span>
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            {{ __('Choose File') }}
                                            ...
                                            <div class="form-group">
                                                <div class="input-group gallery-modal" id="btnSubmit"
                                                    ...
                                                    <input type="hidden" name="images"
                                                        ...
                                                        class="image-selected">
                                                    <span class="form-control"><span
                                                            class="counter">{{ old('images') != '' ? substr_count(old('images'), ',') + 1 : 0 }}</span>
                                                        {{ __('file chosen') }}</span>
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            {{ __('Choose File') }}
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectric" name="video_provider"
                                                ...
                                                <option value="youtube"
                                                    {{ old('video_provider') == 'youtube' ? 'selected' : '' }}>
                                                    {{ __('Youtube') }}
                                                </option>
                                                <option value="vimeo"
                                                    {{ old('video_provider') == 'vimeo' ? 'selected' : '' }}>
                                                    {{ __('Vimeo') }}
                                                </option>
                                                <option value="mp4"
                                                    {{ old('video_provider') == 'mp4' ? 'selected' : '' }}>
                                                    {{ __('Mp4') }}
                                                </option>
                                            </select>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <select class="form-control selectric" name="special_discount_type"
                                                ...
                                                <option value="" selected>{{ __('Select Type') }}</option>
                                                <option value="flat"
                                                    {{ old('special_discount_type') == 'flat' ? 'selected' : '' }}>
                                                    {{ __('Flat') }}
                                                </option>
                                                <option value="percentage"
                                                    {{ old('special_discount_type') == 'percentage' ? 'selected' : '' }}>
                                                    {{ __('Percentage') }}
                                                </option>
                                            </select>
...
{{--                                            {{ old('vat_taxes') != '' ? (in_array($vat_tax->id, old('vat_taxes')) ? 'selected' : '') : '' }}>--}}
{{--                                            {{ $vat_tax->vat_tax }}--}}
{{--                                            ({{ $vat_tax->percentage . '%' }})--}}
{{--                                        </option>--}}
{{--                                        @endforeach--}}
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label
                                                for="stock_visibility">{{ __('Stock Visibility') }}</label>
                                            <select class="form-control selectric" name="stock_visibility"
                                                id="stock_visibility">
                                                <option value="hide_stock"
                                                    {{ old('stock_visibility') == 'hide_stock' ? 'selected' : '' }}>
                                                    {{ __('Hide Stock') }}
                                                </option>
                                                <option value="visible_with_quantity"
                                                    {{ old('stock_visibility') == 'visible_with_quantity' ? 'selected' : '' }}>
                                                    {{ __('Visible with quantity') }}
                                                </option>
                                                <option value="visible_with_text"
                                                    {{ old('stock_visibility') == 'visible_with_text' ? 'selected' : '' }}>
                                                    {{ __('Visible with text') }}
                                                </option>
                                            </select>
                                ...
                                <div class="with-variant {{ old('has_variant') == 1 ? '' : 'd-none' }}">
                                    ...
                                    <div class="form-group row variant-table">
                                        {{-- Variants --}}
                                        {{-- Path: /public/resources/views/admin/products/products/variants.blade.php --}}
                            ...
                            <div class="card-body">
                                <div class="form-group short-des">
                                    ...
                                    <div>
                                        ...
                                        <textarea type="text" class="summernote ai_short_description" name="short_description" id="short_description">{{ old('short_description') ? old('short_description') : '' }}</textarea>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div>
                                        ...
                                        <textarea type="text" class="summernote ai_description" name="question" id="question"></textarea>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group gallery-modal" id="btnSubmit" data-for="pdf"
                                            ...
                                            <input type="hidden" name="pdf_specification"
                                                ...
                                                class="image-selected">
                                            <span class="form-control"><span
                                                    class="counter">{{ old('pdf_specification') != '' ? substr_count(old('pdf_specification'), ',') + 1 : '' }}</span>
                                                {{ __('file chosen') }}</span>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    {{ __('Choose File') }}
                    ...
                    {{-- <div class="tab-pane fade" id="shipping" role="tabpane2" aria-labelledby="shipping-tab">
                        <div class="card">
                            ...
                            <div class="card-body extra-padding">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric" name="shipping_class_id">
                                        ...
                                        <option value="{{ $shipping_class->id }}"
                                            {{ old('shipping_class_id') == $shipping_class->id ? 'selected' : '' }}>
                                            {{ $shipping_class->name }}
                                        </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric shipping-type"
                                        ...
                                        <option value="flat_rate"
                                            {{ old('shipping_type') == 'flat_rate' ? 'selected' : '' }}>
                                            {{ __('Flat Rate') }}
                                        </option>
                                ...
                                <div
                                    class="shipping-cost {{ old('shipping_type') == 'flat_rate' ? '' : 'd-none' }}">
                                    <div class="form-group">
                                ...
                                <div class="section-title mt-0">
                                    {{ __('Estimated Shipping Days & COD') }}
                                </div>
                                <div
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="number"
                                        value="{{ old('campaign_discount') != '' ? old('campaign_discount') : '' }}"
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control selectric" name="campaign_discount_type"
                                        ...
                                        <option value="flat"
                                            {{ old('campaign_discount_type') == 'flat' ? 'selected' : '' }}>
                                            {{ __('Flat') }}
                                        </option>
                                        <option value="percentage"
                                            {{ old('campaign_discount_type') == 'percentage' ? 'selected' : '' }}>
                                            {{ __('Percent') }}
                                        </option>
                                    </select>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" class="summernote" name="others" id="others">{{ old('others') ? old('others') : '' }}</textarea>
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="meta_title" id="meta_title"
                        ...
                        class="form-control" placeholder="{{ __('Meta Title') }}">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control" name="meta_description" rows="5">{{ old('meta_description') ? old('meta_description') : '' }}</textarea>
                </div>
                <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                            ...
                            <input type="hidden" name="meta_image"
                                ...
                                class="image-selected">
                            <span class="form-control"><span
                                    class="counter">{{ old('meta_image') != '' ? substr_count(old('meta_image'), ',') + 1 : '' }}</span>
                                {{ __('file chosen') }}</span>
                            <div class="input-group-prepend">
                                <div class="input-group-text">
                                    {{ __('Choose File') }}
