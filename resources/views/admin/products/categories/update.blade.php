                                    ...
                                    <div class="input-group category-icon-selector">
                                        <div class="input-group-append" id="uip-select-input">
                                            <div class="input-group-text" id="uip-icon-container">
                                                <i
                                                    class="{{ $category_language->category->icon }}">{{ $category_language->category->icon ? '' : '?' }}</i>
                                            </div>
                                        </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                            ...
                                            <span class="form-control"><span
                                                    class="counter">{{ $category_language->category->logo_id ? 1 : 0 }}</span>
                                                {{ __('file chosen') }}</span>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group gallery-modal" id="btnSubmit" data-for="image"
                                            ...
                                            <input type="hidden" name="banner"
                                                ...
                                                class="image-selected">
                                            <span class="form-control"><span
                                                    class="counter">{{ $category_language->category->banner_id ? 1 : 0 }}</span>
                                                {{ __('file chosen') }}</span>
                                            <div class="input-group-prepend">
                                                <div class="input-group-text">
                                                    {{ __('Choose File') }}
