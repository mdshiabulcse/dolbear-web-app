                                        ...
                                        <div class="form-group">
                                            ...
                                            <div>
                                                <div class="input-group gallery-modal" id="btnSubmit"  data-for="image" data-selection="single"
                                                    ...
                                                    <input type="hidden" name="image"  value="{{ old('image') !='' ? old('image') : (@$store->image_id ? $store->image_id : '' )}}" id="image" class="image-selected">
                                                    <span class="form-control"><span class="counter">{{ old('image') != '' ? substr_count(old('image'), ',') + 1  : (@$store->image_id != '' ? substr_count(@$store->image_id, ',') + 1 : 0) }}</span> {{ __('file chosen') }}</span>
                                                ...
                                                <div class="selected-media-box">
                                                    <div class="mt-2 gallery gallery-md d-flex">
                                                        <div class="selected-media mr-2 mb-2 mt-3 ml-0" data-id="{{ @$store->id }}">
                                                            <img src="{{ @$store->image }}" alt="img-thumbnail"
