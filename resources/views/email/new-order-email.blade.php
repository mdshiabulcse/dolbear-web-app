...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f5f6fa;">
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; border: 1px solid #ddd; border-radius: 5px; font-family: Helvetica, Arial, sans-serif; font-weight: '300'">
        <div style="background-color: #222; color: #fff; padding: 40px 15px; text-align: left; font-size: 30px;">
            <strong>New Order: {{$content->code}}</strong>
        </div>
        <div style="padding: 20px; color: #333030">
            <p style="font-size: 16px; margin: 0 0 10px;">
                You've received the following order from {{$content->billing_address['name']}}:
            </p>
            <p style="margin: 0 0 15px;">
                <a href="#" style="color: #000000; text-decoration: underline; font-weight: bold;">[Order {{$content->code}}]</a>
            ...
            <table style="width: 100%; border-collapse: collapse; border: 1px solid #ddd;">
                <tbody>
                    <tr>
                        ...
                        <td style="padding: 10px; text-align: left; border: 1px solid #ddd; width: 50%;">৳ {{$content->sub_total}}</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td style="padding: 10px; text-align: left; border: 1px solid #ddd; width: 50%;"> {{ ucwords(str_replace('_', ' ', $content->payment_type)) }} </td>
                    </tr>
                    <tr>
