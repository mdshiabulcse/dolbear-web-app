...
<body width="100%" style="margin: 0; padding: 0 !important; mso-line-height-rule: exactly; background-color: #f5f6fa;">
    <div
        ...
        <div style="background-color: #222; color: #fff; padding: 40px 15px; text-align: left; font-size: 30px; ">
            <strong>Order: {{$content->code}}</strong>
        </div>
        <div style="padding: 20px;">
            <p style="font-size: 16px; margin: 0 0 10px;">Hi {{$content->billing_address['name']}}, <br>
                Your order status has been updated to
                <strong>{{ ucwords(str_replace('_', ' ', $content->delivery_status)) }}</strong>.
            </p>
