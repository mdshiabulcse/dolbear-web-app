            ...
            <div class="sg-shipping">
              ...
              <div class="card-list">
                <ul class="global-list grid-3">
                  <li
                    v-if="
                      settings.is_paypal_activated == 1 && settings.paypal_key
                    "
                  >
                  ...
                  >
                    <div class="input-checkbox">
                      ...
                      <label for="ssl_commerze">
                        <img
                          :src="getUrl('images/payment-method/sslcommerze.svg')"
                          alt="sslcommerze"
                          width="90"
                        />
                  ...
                  <li v-if="settings.is_google_pay_activated">
                    <div class="input-checkbox">
                      ...
                      <label for="google_pay">
                        <img
                          :src="getUrl('images/payment-method/google_pay.svg')"
                          alt="google_pay"
                          width="90"
                          class="img-fluid"
                  ...
                  >
                    <div class="input-checkbox">
                      ...
                      <label for="pay_later">
                        <img
                          :src="getUrl('images/payment-method/paylater.svg')"
                  ...
                  <li v-if="payment_form.total > 0 && !code && !check_cod">
                    <div class="input-checkbox">
                      ...
                      <label for="cash">
                        <img
                          :src="getUrl('images/payment-method/cash.svg')"
                          :alt="payment_form.payment_type"
                          class="img-fluid"
                        />
                    ...
                    <div class="input-checkbox">
                      ...
                      <label for="hitpay">
                        <img
                          ...
                          class="img-fluid"
                        />
                        {{ lang.pay_with_hitpay }}
                      </label>
                    </div>
                  </li>
                  <li v-if="settings.is_dpo_activated">
                    <div class="input-checkbox">
                      <input
                        type="radio"
                        value="dpo"
                      ...
                      <label for="dpo">
                        <img
                          :src="getUrl('images/payment-method/dpo.svg')"
                          alt="dpo"
                          class="img-fluid"
                        />
                        {{ lang.pay_with_dpo }}
            ...
            <div class="order-summary">
              ...
              <div class="sg-card">
                <form
                  :action="
                    authUser
                      ...
                      : getUrl('user/complete-order?code=' + code + '&guest=1')
                  "
                  method="post"
                >
                ...
                <loading_button
                  v-if="
                    loading &&
                    (payment_form.payment_type == 'cash_on_delivery' ||
                ...
                <a
                  ...
                  v-if="
                    payment_form.payment_type == 'cash_on_delivery' ||
                    payment_form.payment_type == 'pickup_from_shop' ||
                    payment_form.payment_type == 'pay_later'
                  "
                  >{{ lang.confirm }}</a
                >
...
export default {
  ...
  methods: {
    takeOrders() {
      ...
      axios.get(url).then((response) => {
        ...
        if (response.data.error) {
          ...
          if (!this.trx_id) {
            toastr.warning(
              this.lang.something_went_wrong_try_chooing_address,
              this.lang.Warning + " !!"
            );
    ...
    integrateRazorPay() {
      ...
      if (this.settings.is_razorpay_activated == 1 && this.indian_currency) {
        ...
        myScript.setAttribute(
          "data-amount",
          this.round(
            this.payment_form.total * 100 * this.indian_currency.exchange_rate
          )
        );
    ...
    payment(wallet) {
      ...
      alert(this.payment_form.payment_type);
