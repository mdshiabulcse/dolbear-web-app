                                                    ...
                                                    <li class="media" v-for="(blog,index) in recent_posts.data"
                                                        ...
                                                        <div class="entry-thumbnail">
                                                            <router-link
                                                                ...
                                                                <img loading="lazy" :src="blog.recent_post_image" :alt="blog.title"
                        ...
                        <div class="blog-details">
                            <div class="post">
                                <div class="entry-header">
                                    <div class="entry-thumbnail">
                                        <a>
                                            <img loading="lazy" :src="blogDetails.banner_img" v-if="blogDetails.banner_img" :alt="blogDetails.title " class="img-fluid">
                                    ...
                                    <div class="entry-meta">
                                        <ul class="global-list" v-if="lengthCounter(blogDetails)>0">
                                            <li v-if="blogDetails.user"><a href="javascript:void(0)"><img
                                                ...
                                                loading="lazy" :src="blogDetails.user.user_profile_image" :alt="blogDetails.user.full_name"
