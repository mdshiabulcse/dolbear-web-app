<template>
  <header
    class="sg-header home-4"
    :class="{
      'sidebar-active': smCategory,
            ...
            <ul class="global-list d-flex align-items-center">
              ...
              <li v-if="settings.currency_switcher != 0">
                <div class="dropdown">
                  <button
                    ...
                    type="button"
                    id=""
                    @click.stop="currencyDropdown"
                    :class="{ show: currency_dropdown }"
                    data-bs-toggle="dropdown"
                    aria-expanded="false"
                  >
                    {{ activeCurrency.name }}
              ...
              <li v-if="settings.topbar_play_store_link == 1">
                <a :href="settings.play_store_link" target="_blank"
                  ><span class="mdi mdi-name mdi-google-play"></span>
                  <small>{{ lang.play_store }}</small></a
                >
              </li>
              <li v-if="settings.topbar_app_store_link == 1">
                <a :href="settings.apple_store_link" target="_blank"
                  ><span class="mdi mdi-name mdi-apple"></span>
                  <small>{{ lang.app_store }}</small></a
                >
              </li>
              <li
                v-if="
            ...
            <ul class="global-list">
              <li>
                ...
                >
                  <strong
                    >{{ lang.call }}:
                    {{ settings.header_contact_phone }}</strong
                  >
                </a>
              </li>
              <li>
            ...
            <div class="offer">
              <router-link :to="{ name: 'daily.deals' }">
                <span
                  ...
                  :class="{ active: $route.path == '/daily-deals' }"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    aria-hidden="true"
              ...
              <router-link
                :to="{ name: 'gift.idea' }"
                v-if="addons.includes('ramdhani')"
              >
                <span
                  class="daily--icon business_idea"
      ...
      <div class="categorie-menu-content">
        ...
        <ul @click.stop class="global-list">
          <li
            ...
            :class="{ 'sg-dropdown': Object.keys(menu).length > 2 }"
          >
            <a v-if="urlCheck(menu.url)" :href="menu.url"
              >{{ menu.label
              }}<span
                v-if="Object.keys(menu).length > 2"
                class="icon mdi mdi-name mdi-chevron-down"
            ...
            <ul
              class="sg-dropdown-menu"
              :class="{
                'd-block': home_child_id == menu.id,
                'd-none': home_child_id != menu.id,
              }"
              v-if="Object.keys(menu).length > 2"
            >
              <li
                ...
                v-if="sub_menu.url"
              >
                <a v-if="urlCheck(sub_menu.url)" :href="sub_menu.url">{{
                  sub_menu.label
                }}</a>
                <router-link v-else :to="sub_menu.url">{{
                  sub_menu.label
        ...
        <ul @click.stop class="global-list">
          ...
          >
            ...
            >
              <li
                class="active"
                v-for="(child_category, index) in category.child_categories"
                :key="index"
                :class="
                  child_category.categories.length > 0 ? 'sg-dropdown' : ''
                "
              >
                <router-link
                  :to="{
          ...
          <ul class="global-list">
            <li>
              <a
                ...
                class="sg-toggle"
              >
                <img :src="getUrl('images/others/list.svg')" alt="menu" />
              </a>
            </li>
            <li>
              <router-link :to="{ name: 'home' }" aria-current="page">
                <img :src="getUrl('images/others/home.svg')" alt="Home" />
              </router-link>
            </li>
            <li>
              <a
                href="javascript:void(0)"
                @click.stop="categoryMenu"
                class="sg-toggle"
              >
                <img :src="getUrl('images/others/menu.svg')" alt="List" />
              </a>
            </li>
            <li>
              <router-link :to="{ name: 'cart' }" class="c-toggle">
                <img
                  :src="getUrl('images/others/shopping-bag.svg')"
                  alt="shopping-bag"
                />
              </router-link>
            </li>
            <li>
              <div v-if="authUser">
                <router-link
                  ...
                  :to="{ name: 'dashboard' }"
                >
                  <img :src="getUrl('images/others/user.svg')" alt="User" />
                </router-link>
                <a
                  class="d-block"
                  :href="getUrl('seller/dashboard')"
                  v-else-if="authUser.user_type == 'seller'"
                  ><img :src="getUrl('images/others/user.svg')" alt="User"
                /></a>
                <a
                  class="d-block"
