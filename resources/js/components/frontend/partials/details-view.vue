<template>
  <div v-if="productDetails.id">
    <div class="row">
      <div
        :class="{
          'col-lg-4 col-md-12': $route.name == 'product.details',
          'col-lg-5': $route.name != 'product.details',
        }"
        ...
        <div class="product-slider-section slider-arrows">
          <div>
            ...
            <div class="images-wrapper">
              <div
                class="image"
                v-for="(image, imageIndex) in productDetails.gallery.large"
                :key="imageIndex"
          ...
          >
            <div
              v-for="(image, small_image_index) in productDetails.gallery.small"
              :key="small_image_index"
              :class="{ active: small_image_index == current_index }"
              @click="activeImage(small_image_index)"
              class="thumb-item"
            >
          ...
          <productVideo
            v-if="productDetails.video_link"
      ...
      <div
        :class="{
          'col-lg-8 col-md-12': $route.name == 'product.details',
          'col-lg-7': $route.name != 'product.details',
        }"
      >
        <div class="row justify-content-md-center">
          <div
            :class="{
              'col-lg-8 col-md-8': $route.name == 'product.details',
              'col-lg-12': $route.name != 'product.details',
            }"
          >
            <div class="product-details-2">
              ...
              <div
                class="product-quantity product-border"
                v-if="
                  settings.wholesale_price_variations_show == 1 &&
              ...
              <!-- product-offer -->
              <div
                class="product-details-totalPrice product-border"
                v-if="
                  productDetails.is_digital != 1 &&
              ...
              <div
                ...
                class="product-details-query mt-3 product-border"
              >
                <h3
                  v-if="
                ...
                <div class="product-cart sg-quantity" v-if="productType()">
                  ...
                  <!-- <div class="buyNowBTN d-flex align-items-center">
                    <a
                      href="javascript:void(0)"
                      @click="
                        addToCart(productDetails.minimum_order_quantity, 1, 1)
                      "
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                  ...
                  <table class="table table-bordered">
                    <tbody>
                      ...
                      <tr v-if="productDetails.contact_info.phone_no">
                        ...
                        <td>
                          <a
                            :href="'tel' + productDetails.contact_info.phone_no"
                            >{{ productDetails.contact_info.phone_no }}</a
                          >
                        </td>
                      </tr>
                      <tr v-if="productDetails.contact_info.email">
                        ...
                        <td>
                          <a
                            :href="'mailto' + productDetails.contact_info.email"
                            >{{ productDetails.contact_info.email }}</a
                          >
                        </td>
                      </tr>
              ...
              <div
                class="buttons"
                v-else-if="
                  productDetails.is_catalog == 1 && productDetails.external_link
                "
              >
                <a
                  target="_blank"
                  :href="productDetails.external_link"
              ...
              <div
                class="product-details-policy product-border mt-4"
                v-if="
              ...
              >
                <div class="related-product-shop">
                  ...
                  <div class="related-product-content">
                    <h3 v-if="settings.refund_protection_sub_title">
                      {{ settings.refund_protection_sub_title }}
                    </h3>
                    <h4 v-if="settings.refund_protection_title">
                      {{ settings.refund_protection_title }}
                    </h4>
                  </div>
                  <div class="policy" v-if="settings.refund_policy_agreement">
                    <a
                      v-if="urlCheck(settings.refund_policy_agreement)"
                      :href="settings.refund_policy_agreement"
                      >{{ lang.view_policy }}</a
                    >
                    <router-link
                      v-else
                      :to="'/page/' + settings.refund_policy_agreement"
                      >{{ lang.view_policy }}
                    </router-link>
                  </div>
                </div>
                ...
                <ul class="global-list d-flex">
                  <li class="fb-icon">
                    <a
                      ...
                      "
                      ><span class="mdi mdi-name mdi-facebook"></span
                    ></a>
                  </li>
                  <li class="tw-icon">
                    <a
                      ...
                      :href="
                        ...
                        getUrl('product/' + productDetails.slug)
                      "
                      ><span class="mdi mdi-name mdi-twitter"></span
                    ></a>
                  </li>
                  <li class="ld-icon">
                    <a
                  ...
                  <li class="wh-icon">
                    <a
                      ...
                      :href="
                        ...
                        getUrl('product/' + productDetails.slug)
                      "
                      ><span class="mdi mdi-name mdi-whatsapp"></span
                    ></a>
                  </li>
                </ul>
              </div>
          ...
          >
            <div class="sg-seller-product pb-sm-3">
              ...
              <div
                class="product-offer"
                v-if="settings.product_details_site_banner"
              >
                <img
                  loading="lazy"
                  :src="settings.product_details_site_banner"
                  alt="banner-image"
                  class="img-fluid"
                />
              </div>
              <div
                class="product-widget-recent-entries"
                v-if="productDetails.sidebar_products.length > 0"
              >
                <h4>{{ lang.recent_products }}</h4>
                <ul class="global-list">
                  <li
                    v-for="(product, index) in productDetails.sidebar_products"
                    :key="index"
                  >
                    <div class="shop">
                      <div class="thumb">
        ...
        <div class="products-description product-details-description">
          <ul class="nav nav-tabs description-tabs" role="tablist">
            <li role="presentation" class="nav-item">
              <a
                class="nav-link"
                :class="{ active: activeNav == 'details' }"
                href="javascript:void(0)"
            ...
            <li
              ...
              v-if="
                ...
                productDetails.language_product.specification
              "
            >
              <a
                class="nav-link"
                :class="{ active: activeNav == 'specifications' }"
                href="javascript:void(0)"
            ...
            <li class="nav-item" role="presentation">
              <a
                class="nav-link"
                :class="{ active: activeNav == 'delivery' }"
                href="javascript:void(0)"
          ...
          <div class="tab-content">
            <div
              role="tabpanel"
              class="tab-pane fade"
              :class="{ 'show active': activeNav == 'details' }"
              id="details"
            >
              <div
                v-if="productDetails.language_product"
                v-html="productDetails.language_product.description"
              ></div>
              <div
                class="text-center"
                v-if="productDetails.description_image.length > 0"
              >
                <div
                  class="mt-3"
                  v-for="(image, index) in productDetails.description_image"
                  :key="index"
                >
                  <img
                    loading="lazy"
            ...
            <div
              ...
              v-if="
                ...
                productDetails.language_product.specification
              "
              :class="{ 'show active': activeNav == 'specifications' }"
              id="specifications"
            >
              <div class="specifications">
                <iframe
                  :src="productDetails.language_product.specification"
                  height="842px"
                ></iframe>
              </div>
              <!-- /.specifications -->
