        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-6" :class="[classObj()]">
            <div class="footer-widget widget-border">
              ...
              <ul
                class="global-list"
                v-else-if="authUser && authUser.user_type == 'seller'"
              >
                <li>
          ...
          <div class="payment-card">
            <ul class="global-list">
              <li v-if="settings.visa_pay_banner">
                <img
                  :src="getUrl('images/payment-method/visa.svg')"
                  alt="visa_pay_banner"
              ...
              <li v-if="settings.master_card_pay_banner">
                <img
                  :src="getUrl('images/payment-method/master-card.svg')"
              ...
              <li v-if="settings.american_express_pay_banner">
                <img
                  :src="getUrl('images/payment-method/american-express.svg')"
              ...
              <li v-if="settings.apple_pay_banner">
                <img
                  :src="getUrl('images/payment-method/apple-pay.svg')"
              ...
              <li v-if="settings.amazon_pay_banner">
                <img
                  :src="getUrl('images/payment-method/amazon-pay.svg')"
              ...
              <li v-if="settings.after_pay_banner">
                <img
                  :src="getUrl('images/payment-method/after-pay.svg')"
                  alt="after_pay_banner"
                  class="img-fluid footer-payment-icon"
                />
              </li>
              <li
                v-if="settings.payment_method_banner"
                class="full-payment-img"
              >
                <img
                  :src="settings.payment_method_banner"
