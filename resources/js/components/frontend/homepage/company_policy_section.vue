    ...
    <div class="container">
      <div class="row horizontal-scroll">
        <div class="col-md-2 col-sm-4">
          ...
          <p class="section-text">Cash On Delivery</p>
        </div>
        <div class="col-md-2 col-sm-4">
          <div class="round-icon padding-left">
            <svg
          ...
          <p class="section-text"># Days Delivery</p>
        </div>
        <div class="col-md-2 col-sm-4">
          <div class="round-icon padding-left">
            <svg
          ...
          <p class="section-text">Return Opportunity</p>
        </div>
        <div class="col-md-2 col-sm-4">
          <div class="round-icon padding-left">
            <svg
