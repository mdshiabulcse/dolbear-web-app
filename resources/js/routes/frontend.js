import Outlets_new from "../components/frontend/pages/outlets_new.vue";
import Track_order_new from "../components/frontend/pages/track_order_new.vue";

const home = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/home");

const home_new = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/home_new");
const products_new = () =>
  import(
    /* webpackPrefetch: true */ "../components/frontend/pages/products_new.vue"
  );

const about = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/about");
const allBlogs = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/blogs");
const blogDetails = () =>
  import(
...
const brands = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/brands");
const sellers = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/all-seller");
...
// const allCategory = () =>
//   import(/* webpackPrefetch: true */ "../components/frontend/pages/category");
...
const shop_all = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/shop-all.vue");
...
const giftIdea = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/gift-idea");
const businessIdea = () =>
  import(
    /* webpackPrefetch: true */
...
const productDetailsNew = () =>
  import(
    /* webpackPrefetch: true */
    "../components/frontend/pages/product_details_new.vue"
  );
const trackOrder = () =>
  import(
    /* webpackPrefetch: true */
...
const checkout = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/checkout");
const payment = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/payment");
...
const cart = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/cart");

const cartNew = () =>
  import(
    /* webpackPrefetch: true */ "../components/frontend/pages/cart_new.vue"
  );
const login = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/login");
const register = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/register");
...
const flashSale = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/flash-sale");
const compareList = () =>
  import(
    /*webpackPrefetch: true */
...
const addresses = () =>
  import(
    /* webpackPrefetch: true */
    "../components/frontend/pages/user/addresses_new"
  );
const getInvoice = () =>
  import(
    /* webpackPrefetch: true */
...
const shop = () =>
  import(/* webpackPrefetch: true */ "../components/frontend/pages/shop");
const followedShop = () =>
  import(
    /* webpackPrefetch: true */
    "../components/frontend/pages/user/followed-shop"
  );
const digitalProductOrders = () =>
  import(
    /* webpackPrefetch: true */
...
const error_404 = () =>
  import(/* webpackPrefetch : true" */ "../components/errors/not_found");
const affiliate_register = () =>
  import(
    /* webpackPrefetch: true */
...
export const routes = [
  {
    path: "/",
    component: () =>
      import(/* webpackPrefetch : true" */ "../components/frontend/master"),
